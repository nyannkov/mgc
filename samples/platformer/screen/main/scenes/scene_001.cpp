...
const mgc_dlg_node node_array[] = {
    {0, MGC_DLG_TRUE, "\n            〜このサンプルについて〜", MGC_DLG_ON_BUTTON_PRESSED, MGC_DLG_STEP, 0},
    {1, MGC_DLG_TRUE, "このサンプルは開発進捗に応じて内容が変更される場合がございます。", MGC_DLG_ON_BUTTON_PRESSED, MGC_DLG_EXIT, 0},
    {10, MGC_DLG_TRUE, "外に出ますか？", MGC_DLG_ON_RECEIVE_YESNO, MGC_DLG_STEP, 0},
