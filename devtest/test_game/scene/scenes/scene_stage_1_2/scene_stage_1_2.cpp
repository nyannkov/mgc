...
Scene_Stage1_2::Scene_Stage1_2(GameContext& ctx) 
            : SceneBase(ctx),
              stage_(scx_.timer),
              scene_objects_(scx_) {

    set_id(SceneId::Stage1_2);
...
void Scene_Stage1_2::init() {
    ...
    stage_.setup(stage::StageId::Stage1_2);
...
void Scene_Stage1_2::draw(mgc::graphics::Framebuffer& fb) {
