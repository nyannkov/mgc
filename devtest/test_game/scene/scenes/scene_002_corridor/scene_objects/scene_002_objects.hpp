#ifndef MGC_SCENE_002_OBJECTS_HPP
#define MGC_SCENE_002_OBJECTS_HPP
...
namespace app {
struct Scene002_Objects : ISceneObjects {

    explicit Scene002_Objects(SceneContext& scx)
...
#endif // MGC_SCENE_002_OBJECTS_HPP
