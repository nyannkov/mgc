#ifndef MGC_SCENE_STAGE_3_2_HPP
#define MGC_SCENE_STAGE_3_2_HPP
...
struct Scene_Stage3_2 : SceneBase {

    explicit Scene_Stage3_2(GameContext& ctx);
    void init() override;
