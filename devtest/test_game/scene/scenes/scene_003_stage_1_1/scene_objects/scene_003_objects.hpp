#ifndef MGC_SCENE_003_OBJECTS_HPP
#define MGC_SCENE_003_OBJECTS_HPP
...
namespace app {
struct Scene003_Objects : ISceneObjects {

    explicit Scene003_Objects(SceneContext& scx)
        : cp_info_(scx.checkpoint_info),
          ...
          gate_1_(scx.gamepad),
          gate_2_(scx.gamepad),
          props_ { &signboard_, &gate_1_, &gate_2_ } {
    }
...
#endif // MGC_SCENE_003_OBJECTS_HPP
