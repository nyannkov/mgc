#ifndef MGC_SCENE_999_GameOver_HPP
#define MGC_SCENE_999_GameOver_HPP
...
struct Scene999_GameOver : SceneBase {

    explicit Scene999_GameOver(GameContext& ctx);
    void init() override;
...
#endif/*MGC_SCENE_999_GameOver_HPP*/
