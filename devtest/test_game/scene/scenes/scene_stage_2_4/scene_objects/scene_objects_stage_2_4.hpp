#ifndef MGC_SCENE_OBJECTS_STAGE_2_4_HPP
#define MGC_SCENE_OBJECTS_STAGE_2_4_HPP
...
namespace app {
struct SceneObjects_Stage2_4 : ISceneObjects {

    explicit SceneObjects_Stage2_4(SceneContext& scx)
        : cp_info_(scx.world_state.checkpoint_info),
          ...
          props_ { &gate_1_, &gate_2_, &gate_3_, &signboard_, &portal_1_ }
        { }
...
#endif // MGC_SCENE_OBJECTS_STAGE_2_4_HPP
