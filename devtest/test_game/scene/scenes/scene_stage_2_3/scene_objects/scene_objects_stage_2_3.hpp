#ifndef MGC_SCENE_OBJECTS_STAGE_2_3_HPP
#define MGC_SCENE_OBJECTS_STAGE_2_3_HPP
...
namespace app {
struct SceneObjects_Stage2_3 : ISceneObjects {

    explicit SceneObjects_Stage2_3(SceneContext& scx)
        : cp_info_(scx.world_state.checkpoint_info),
          ...
          gate_2_(scx.gamepad),
          gate_3_(scx.gamepad),
          props_ { &gate_1_, &gate_2_, &gate_3_ }
        { }
...
#endif // MGC_SCENE_OBJECTS_STAGE_2_3_HPP
