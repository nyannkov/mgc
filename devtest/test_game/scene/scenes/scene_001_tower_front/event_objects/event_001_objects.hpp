#ifndef MGC_EVENTS_001_OBJECTS_HPP
#define MGC_EVENTS_001_OBJECTS_HPP
...
struct Event001_Objects : IEventObjects {

    Event001_Objects(SceneContext& scx, Scene001_Objects& objs)
