#ifndef MGC_SCENE_001_OBJECTS_HPP
#define MGC_SCENE_001_OBJECTS_HPP
...
namespace app {
struct Scene001_Objects : ISceneObjects {

    explicit Scene001_Objects(SceneContext& scx) 
    ...
    void init() override {
        ...
        entrance_.set_scene_transition_request( { SceneId::Id_002_Corridor });
        if ( !cp_info_.has_reached(Checkpoint::TowerFrontEvent_Finished) ) {
...
#endif // MGC_SCENE_001_OBJECTS_HPP
