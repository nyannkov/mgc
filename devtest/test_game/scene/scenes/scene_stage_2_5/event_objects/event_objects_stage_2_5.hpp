#ifndef MGC_EVENTS_OBJECTS_STAGE_2_5_HPP
#define MGC_EVENTS_OBJECTS_STAGE_2_5_HPP
...
struct EventObjects_Stage2_5 : IEventObjects {

    EventObjects_Stage2_5(SceneContext& scx, SceneObjects_Stage2_5& objs)
...
private:
    ...
    Event_Stage2_5 event_1_;
    std::array<event::Event*, 1> events_;
};

}// namespace app

#endif/*MGC_EVENTS_OBJECTS_STAGE_2_5_HPP*/
