...
python3 ${MAP_GEN}          ${COMMON_PATH}/assets/map/map_01.csv --compression runlength --dir ./resources/generated/map
python3 ${MAP_GEN}          ${COMMON_PATH}/assets/map/map_01_fg.csv --compression runlength --dir ./resources/generated/map
