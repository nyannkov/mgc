...
GENERATES_SRC := $(GENERATES_TILESET_PATH)/tileset_balls.c \
                 $(GENERATES_TILESET_PATH)/tileset_map_elements.c \
                 $(GENERATES_MAP_PATH)/sample_map.c
...
# tileset_gen
$(GENERATES_TILESET_PATH)/tileset_balls.c: $(RESOURCES_TILESET_PATH)/tileset_balls.bmp
	python3 $(TILESET_GEN_PATH) $< --dir $(GENERATES_TILESET_PATH) --count 8

$(GENERATES_TILESET_PATH)/tileset_map_elements.c: $(RESOURCES_TILESET_PATH)/tileset_map_elements.bmp
	python3 $(TILESET_GEN_PATH) $< --dir $(GENERATES_TILESET_PATH) --count 2
