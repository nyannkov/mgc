...
struct WithFont {
    ...
    const mgc::parts::assets::Font *get_font() const {
        return static_cast<const Derived*>(this)->get_font();
    }

    void set_fore_color(mgc::graphics::Color color) {
        static_cast<Derived*>(this)->set_fore_color_impl(color);
    }

    mgc::graphics::Color get_fore_color() const {
        return static_cast<const Derived*>(this)->get_fore_color_impl();
    }
};
